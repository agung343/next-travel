        ...
        <section className="max-container padding-container flex flex-col gap-20 py-10 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl: w-1/2">
                <Image
                    ...
                    alt="camp"
                    width={50} height={50}
                    className="absolue left-[-5px] top-[-30px] w-10 lg:w-[50px]"
                />
                <h1 className="bold-52 lg:bold-88">Putuk Truno Camp Area</h1>
                <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
                    Sed sed dictum nulla. Maecenas et mi vel dolor mollis fringilla. Pellentesque ac mauris et ipsum porttitor fermentum eget ut lectus. Mauris viverra eu erat.
                </p>
                ...
                <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
                    ...
                    <div className="flexBetween">
                        <div className="flex flex-col">
                            ...
                            <p className="bold-20 text-white">23 kilometes</p>
                        </div>
                        <div className="flex flex-col">
                            <p className="regular-16 block text-gray-20">Ketinggian</p>
                            <p className="bold-20 text-white">806 mdpl</p>
                        </div>
                    </div>
                </div>
            </div> */}
